...
public class ThyraBehavior : ModelBehaviorAbstratScript
{
    [SerializeField] private ParaScriptableObject m_thyraScript;


    [SerializeField] private Animator m_animator;

    private const string IDLE = "Idle";
    private const string ATTACK = "Jumping";
    ...
    void Start()
    {
        ...
        currentHealth = m_thyraScript.maxHealth;
        maxhealth = m_thyraScript.maxHealth;
